/*
  # Complete Blog Platform Schema - Initial Setup
...
DROP POLICY IF EXISTS "All posts are viewable by authenticated users" ON blog_posts;
DROP POLICY IF EXISTS "Posts can be inserted by authenticated users" ON blog_posts;
DROP POLICY IF EXISTS "Posts can be updated by authenticated users" ON blog_posts;
DROP POLICY IF EXISTS "Posts can be deleted by authenticated users" ON blog_posts;
DROP POLICY IF EXISTS "Post tags are viewable by everyone" ON post_tags;
DROP POLICY IF EXISTS "Post tags can be managed by authenticated users" ON post_tags;
DROP POLICY IF EXISTS "Post views can be created by everyone" ON post_views;
DROP POLICY IF EXISTS "Post views are viewable by authenticated users" ON post_views;
